...
interface InstrumentScreeningHistoryStackedColumnChartProps {
  instrumentId: string;
}

export const InstrumentScreeningHistoryStackedColumnChart: React.FC<
  InstrumentScreeningHistoryStackedColumnChartProps
> = ({ instrumentId }) => {
      ...
      <Paper sx={{ p: 2, height: 400 }}>
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={chartData}>
            ...
            <Tooltip />
            <Legend />
            <Bar dataKey="pending" stackId="a" fill={COLORS.pending} name="Pendente" />
            <Bar dataKey="in_progress" stackId="a" fill={COLORS.in_progress} name="Em Andamento" />
            <Bar dataKey="completed" stackId="a" fill={COLORS.completed} name="Concluído" />
            <Bar dataKey="cancelled" stackId="a" fill={COLORS.cancelled} name="Cancelado" />
          </BarChart>
        </ResponsiveContainer>
      </Paper>
