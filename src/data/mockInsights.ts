...
export const mockInsights: ActionableInsight[] = [
  {
    ...
    description: 'Identificada uma queda de 15% no desempenho médio de leitura dos alunos do 3º ano nas últimas avaliações.',
    alertLevel: 'high',
    ...
    evidence: {
      ...
      sources: ['Avaliações formativas', 'Registros de leitura semanal', 'Comparativo com anos anteriores']
    }
  },
  {
    id: '2',
    title: 'Aumento na ausência escolar',
    description: 'Aumento significativo nas ausências de estudantes, especialmente às segundas e sextas-feiras.',
    alertLevel: 'moderate',
  ...
  },
  {
    ...
    description: 'As intervenções de matemática para o 5º ano não estão produzindo os resultados esperados após 8 semanas.',
    alertLevel: 'critical',
  ...
  },
  {
    ...
    description: 'Identificado potencial para ampliar o impacto do programa socioemocional com base em novas evidências.',
    alertLevel: 'low',
  ...
  },
  {
    ...
    description: 'Identificado padrão consistente de dificuldade em escrita narrativa entre alunos do 4º ano.',
    alertLevel: 'moderate',
  ...
  },
  {
    ...
    description: 'Grupo de alunos identificados com potencial para aceleração em ciências com base em desempenho consistente.',
    alertLevel: 'low',
  ...
  },
  {
    ...
    description: 'Identificada necessidade de apoio aos professores para implementação efetiva de estratégias de diferenciação.',
    alertLevel: 'moderate',
  ...
  },
  {
    ...
    description: 'Grupo de 12 alunos identificados com alto risco de retenção com base em múltiplos indicadores.',
    alertLevel: 'critical',
