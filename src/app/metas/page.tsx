...
const EXAMPLE_GOALS: SmartGoal[] = [
  ...
  },
  {
    ...
    specificDetails: 'Reduzir a frequência de interrupções em sala de aula de média de 12 para 3 por dia, medidas por observação direta',
    measurement: {
      initialValue: 12,
      targetValue: 3,
      currentValue: 8,
      ...
      progressHistory: [
        ...
        { date: new Date('2023-09-24'), value: 10, notes: 'Após implementação de sistema de recompensas' },
        { date: new Date('2023-10-08'), value: 8, notes: 'Melhora gradual com feedback consistente' }
      ]
    },
    achievementSteps: [
    ...
    relevance: 'Reduzir comportamentos disruptivos aumentará o tempo de aprendizagem do aluno e melhorará o ambiente de aprendizagem para toda a turma',
  ...
  },
  {
    ...
    specificDetails: 'Aumentar o escore médio em produção textual de 2,5 para 4,0 em escala de 1-5, conforme rubrica de avaliação',
    measurement: {
      initialValue: 2.5,
      targetValue: 4.0,
      currentValue: 3.2,
      ...
      progressHistory: [
        { date: new Date('2023-08-20'), value: 2.5, notes: 'Avaliação inicial de produção escrita' },
        { date: new Date('2023-09-20'), value: 2.8, notes: 'Após foco em estrutura narrativa' },
        { date: new Date('2023-10-20'), value: 3.2, notes: 'Melhora na coesão e uso de vocabulário' }
      ]
    },
    achievementSteps: [
    ...
    relevance: 'A escrita é uma forma essencial de comunicação acadêmica e profissional; melhorar esta habilidade impactará o desempenho em todas as áreas',
  ...
  },
  {
    ...
    specificDetails: 'Aumentar a frequência de contribuições voluntárias em atividades em grupo de 2 para 8 por aula, medidas por observação estruturada',
    measurement: {
      initialValue: 2,
      targetValue: 8,
      currentValue: 5,
    ...
    relevance: 'Habilidades colaborativas são essenciais para o sucesso acadêmico e profissional futuro, além de melhorarem a integração social',
...
const EXAMPLE_INTERVENTIONS: Intervention[] = [
  {
    ...
    steps: ['Seleção de texto apropriado', 'Demonstração inicial', 'Prática alternada', 'Feedback específico'],
    effectiveness: {
      rating: 4.5,
      studies: 12,
  ...
  },
  {
    ...
    steps: ['Linha de base inicial', 'Leituras repetidas', 'Registro de tempos', 'Análise de progresso'],
    effectiveness: {
      rating: 4.3,
      studies: 15,
  ...
  },
  {
    ...
    materials: ['Folha de pontuação diária', 'Definição clara de comportamentos', 'Sistema de recompensas'],
    steps: ['Check-in matinal', 'Feedback ao longo do dia', 'Check-out vespertino', 'Comunicação com responsáveis'],
    effectiveness: {
      rating: 4.2,
      studies: 22,
      ...
      {(currentView === ViewMode.CREATE || currentView === ViewMode.EDIT) && (
        <SmartGoalForm
          initialData={selectedGoal ? {
            ...
            interventions: Array.isArray(selectedGoal.interventions) && typeof selectedGoal.interventions[0] === 'string'
