...
describe('ActionButton', () => {
  ...
  it('renderiza corretamente com texto básico', () => {
    renderWithTheme(<ActionButton>Clique Aqui</ActionButton>);

    expect(screen.getByText('Clique Aqui')).toBeInTheDocument();
  });

  it('aplica variante primária por padrão', () => {
    renderWithTheme(<ActionButton>Botão Primário</ActionButton>);
  ...
  it('aplica variante secundária quando especificada', () => {
    renderWithTheme(<ActionButton variant="secondary">Botão Secundário</ActionButton>);
  ...
  it('aplica tamanho pequeno quando especificado', () => {
    renderWithTheme(<ActionButton size="small">Botão Pequeno</ActionButton>);
  ...
  it('aplica tamanho grande quando especificado', () => {
    renderWithTheme(<ActionButton size="large">Botão Grande</ActionButton>);
  ...
  it('mostra estado de loading quando especificado', () => {
    renderWithTheme(<ActionButton loading>Carregando</ActionButton>);
  ...
  it('desabilita o botão quando disabled é true', () => {
    renderWithTheme(<ActionButton disabled>Desabilitado</ActionButton>);
  ...
  it('chama onClick quando clicado', () => {
    ...
    renderWithTheme(<ActionButton onClick={handleClick}>Clique-me</ActionButton>);
  ...
  it('aplica className personalizada', () => {
    ...
    renderWithTheme(<ActionButton className={customClass}>Botão com Classe</ActionButton>);
  ...
  it('aplica estilos inline quando style é fornecido', () => {
    ...
    renderWithTheme(<ActionButton style={customStyle}>Botão com Estilos</ActionButton>);
  ...
  it('mantém acessibilidade', () => {
    renderWithTheme(<ActionButton>Botão Acessível</ActionButton>);
